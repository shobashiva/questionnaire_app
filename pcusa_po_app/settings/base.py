...
ROOT_URLCONF = 'pcusa_po_app.urls'
...
#     (101, "forms_builder_addons.RadioButtonGrid", "Radio Button Grid"),
# )
...
# Set Fobi Permissions "off" (revisit later)
...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'pcusa_po_app.settings.base.custom_show_toolbar',
...
WSGI_APPLICATION = 'pcusa_po_app.wsgi.application'
...
SERVER_EMAIL = "processobservations.server@pcusa.org"
DEFAULT_FROM_EMAIL = "no.reply@pcusa.org"
SYSTEM_EMAIL_PREFIX = "[PC-USA]"

# SMTP Settings
EMAIL_HOST = 'email-smtp.us-east-1.amazonaws.com'
EMAIL_PORT = '587'

# EMAIL_HOST_USER = 'AKIAI727LOMBP2LCGP6Q'
# EMAIL_HOST_PASSWORD = 'AqAenrDwiJTOba7wERsYmMIAXDoeVg9o69976/6OOFzV'
# EMAIL_USE_TLS = True
...
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_pcusa_po_app"  # Make this unique to your project.
...
#CEF_PRODUCT = 'pcusa_po_app'
#CEF_VENDOR = 'Your Company'
#CEF_VERSION = '0'
#CEF_DEVICE_VERSION = '0'

AUTHENTICATION_BACKENDS = (
    'api.backend.AESBackend',
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework.authentication.SessionAuthentication', # DEBUG ONLY: Enable for debugging through browsable api
