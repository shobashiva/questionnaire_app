"""
Starter fabfile for deploying the pcbiz_app project.
...
# CHANGEME
env.hosts = ['user@pcbiz_app.example.com']
env.code_dir = '/srv/www/pcbiz_app'
env.project_dir = '/srv/www/pcbiz_app/pcbiz_app'
env.static_root = '/srv/www/pcbiz_app/static/'
env.virtualenv = '/srv/www/pcbiz_app/.virtualenv'
env.code_repo = 'git@github.com:user/pcbiz_app.git'
env.django_settings_module = 'pcbiz_app.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/pcbiz_app/wsgi.py" % env.code_dir)
